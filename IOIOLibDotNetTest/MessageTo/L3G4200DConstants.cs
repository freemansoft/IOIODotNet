...
namespace IOIOLibDotNetTest.MessageTo
{
    internal class L3G4200DConstants
    {
        ...
        internal static float Gyro_DPS_LSB_250 = 0.00875f; // 8.75 mdps/LSB
        internal static float Gyro_DPS_LSB_500 = 0.01750f; // 17.50 mdps/LSB
        internal static float Gyro_DPS_LSB_2000 = 0.07000f; // 70.0 mdps/LSB
